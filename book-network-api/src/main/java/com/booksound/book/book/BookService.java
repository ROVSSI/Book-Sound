...
import com.booksound.book.file.FileStorageService;
import com.booksound.book.history.BookTransactionHistory;
import com.booksound.book.history.BookTransactionHistoryRepository;
...
import static com.booksound.book.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public Integer borrowBook(Integer bookId, Authentication connectedUser) {
        ...
        final boolean isAlreadyBorrowed = transactionHistoryRepository.isAlreadyBorrowed(book, user.getId());
    ...
    public Integer approveReturnBorrowBook(Integer bookId, Authentication connectedUser) {
        ...
        BookTransactionHistory bookTransactionHistory = transactionHistoryRepository.findByBookIdAndOwnerId(bookId, user.getId())
                .orElseThrow(() -> new OperationNotPermittedException("The book is not return yet, so you cannot approve its return"));
